# Django settings for CourseRu project.
...
SECRET_KEY = '3rijsf&amp;$1quc#*t!tpl@^@_##j3d3)t0r*@(-n*v$&amp;h!kzj9l8'
...
MIDDLEWARE_CLASSES = (
    ...
    'CourseRu.usertypemiddleware.UserTypeMiddleware',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'CourseRu.urls'
